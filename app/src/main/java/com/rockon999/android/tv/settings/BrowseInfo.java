...
import com.rockon999.android.tv.settings.accessories.AccessoryUtils;
import com.rockon999.android.tv.settings.accessories.BluetoothAccessoryActivity;
import com.rockon999.android.tv.settings.accounts.AccountImageUriGetter;
import com.rockon999.android.tv.settings.accounts.AccountSettingsActivity;
import com.rockon999.android.tv.settings.accounts.AuthenticatorHelper;
import com.rockon999.android.tv.settings.connectivity.ConnectivityStatusIconUriGetter;
import com.rockon999.android.tv.settings.connectivity.ConnectivityStatusTextGetter;
import com.rockon999.android.tv.settings.connectivity.WifiNetworksActivity;
import com.rockon999.android.tv.settings.device.sound.SoundActivity;
...
public class BrowseInfo extends BrowseInfoBase {
    ...
    private void updateAccessories(int headerId) {
        ...
        ComponentName componentName = new ComponentName("com.rockon999.android.tv.settings",
                "com.rockon999.android.tv.settings.accessories.AddAccessoryActivity");
    ...
    private void addAccounts(ArrayObjectAdapter row) {
        ...
        if (canAddAccount() && (mAllowMultipleAccounts || googleAccountCount == 0)) {
            ComponentName componentName = new ComponentName("com.rockon999.android.tv.settings",
                    "com.rockon999.android.tv.settings.accounts.AddAccountWithTypeActivity");
            Intent i = new Intent().setComponent(componentName);
            i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
