...
public class TextInputWizardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        try {
            Method m = EditText.class.getMethod("setOnEditorActionListener");

            for (Class clazz : EditText.class.getDeclaredClasses()) {
                            ...
                            public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
                                ...
                                if (method.getName().equals("onEditorAction") && objects.length == 3) {
                                    ...
                                    if (event == null || event.getAction() == KeyEvent.ACTION_UP) {
                                        ...
                                        return a instanceof Listener && ((Listener) a).onTextInputComplete(v.getText().toString());
                                    }
                                    return true;
                                }

                                throw new RuntimeException("This should never occur"); // todo?
                            }
                        };
