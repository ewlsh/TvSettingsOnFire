...
package com.rockon999.android.tv.settings.dialog;
...
import com.rockon999.android.tv.settings.widget.BitmapWorkerOptions;
import com.rockon999.android.tv.settings.widget.DrawableDownloader;
import com.rockon999.android.tv.settings.widget.DrawableDownloader.BitmapCallback;
...
public class DialogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.rockon999.android.tv.settings.R.layout.lb_dialog_fragment, container, false);

        View contentContainer = v.findViewById(R.id.content_fragment);
        View content = inflater.inflate(com.rockon999.android.tv.settings.R.layout.lb_dialog_content, container, false);
        ...
        View action = inflater.inflate(com.rockon999.android.tv.settings.R.layout.lb_dialog_action_list, container, false);
    ...
    public Animator onCreateAnimator(int transit, boolean enter, int nextAnim) {
        ...
        View breadcrumbView = (View) contentView.getTag(com.rockon999.android.tv.settings.R.id.breadcrumb);
        View descriptionView = (View) contentView.getTag(R.id.description);
        View iconView = (View) contentView.getTag(R.id.icon);
        View listView = (View) actionView.getTag(com.rockon999.android.tv.settings.R.id.list);
        View selectorView = (View) actionView.getTag(com.rockon999.android.tv.settings.R.id.selector);
    ...
    private void setContentView(View content) {
        ...
        TextView breadcrumbView = (TextView) content.findViewById(com.rockon999.android.tv.settings.R.id.breadcrumb);
    ...
    private void setActionView(View action) {
        ...
        if (action instanceof VerticalGridView) {
            ...
            mListView = (VerticalGridView) action.findViewById(com.rockon999.android.tv.settings.R.id.list);
            if (mListView == null) {
