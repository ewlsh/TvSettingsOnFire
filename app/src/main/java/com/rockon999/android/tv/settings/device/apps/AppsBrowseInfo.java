...
package com.rockon999.android.tv.settings.device.apps;
...
import com.rockon999.android.tv.settings.BrowseInfoBase;
import com.rockon999.android.tv.settings.MenuItem;
            ...
            if (appEntries != null) {
                ...
                for (int i = 0, size = appInfos.size(); i < size; i++) {
                    ...
                    MenuItem menuItem = new MenuItem.Builder()
                            ...
                            .intent(intent)
                            .intentOptions(ActivityOptions.makeCustomAnimation(mContext, android.R.anim.fade_in, android.R.anim.fade_out))
                            .build();
