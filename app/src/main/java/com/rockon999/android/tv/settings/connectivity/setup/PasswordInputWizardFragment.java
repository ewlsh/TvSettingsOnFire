...
public class PasswordInputWizardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        TextViewUtil.setOnEditorActionListener(mTextInput, new TextViewUtil.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (event == null || event.getAction() == KeyEvent.ACTION_UP) {
                    Activity a = getActivity();
                    return (a instanceof Listener) && ((Listener) a).onPasswordInputComplete(v.getText().toString());
                }
