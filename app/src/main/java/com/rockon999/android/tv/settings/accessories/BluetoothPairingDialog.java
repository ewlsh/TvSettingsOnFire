...
import static android.bluetooth.BluetoothDevice.convertPinToBytes;
...
public class BluetoothPairingDialog extends DialogActivity {
    ...
    private static final String TAG = "aah.BluetoothPairDialog";
            ...
            public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                switch (mType) {
                    ...
                    case BluetoothDevice.PAIRING_VARIANT_DISPLAY_PIN:
                        ...
                        if (mType == BluetoothDevice.PAIRING_VARIANT_DISPLAY_PASSKEY) {
                            // todo mDevice.setPairingConfirmation(true);
                        } else if (mType == BluetoothDevice.PAIRING_VARIANT_DISPLAY_PIN) {
                            byte[] pinBytes = convertPinToBytes(mPairingKey);
