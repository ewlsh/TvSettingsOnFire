...
import com.rockon999.android.tv.settings.dialog.old.EditTextFragment;
...
public class DeveloperOptionsActivity extends BaseSettingsActivity
    ...
    protected void refreshActionList() {
        ...
        switch ((ActionType) mState) {
            ...
            case DEVELOPER_DRAWING:
                ...
                // REMOVED: SurfaceFlinger incompatibilites
                //mActions.add(
    ...
    private void setDebugApp(String debugApp) {
        boolean waitForDebugger = mHelper.getGlobalIntSettingToInt(Settings.Global.WAIT_FOR_DEBUGGER) > 0;
    ...
    @Unsupported(reason = "Only system/signed apps can access low-level SurfaceFlinger features")
    @Deprecated
