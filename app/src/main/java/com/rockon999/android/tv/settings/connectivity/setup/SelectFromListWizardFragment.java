...
public class SelectFromListWizardFragment extends Fragment {
    ...
    private static final String TAG = "SelectFromListWizFrag";
    ...
    public static class ListItem implements Parcelable {
        ...
        public static Parcelable.Creator<ListItem> CREATOR = new Parcelable.Creator<ListItem>() {
            ...
            public ListItem createFromParcel(Parcel source) {
                ScanResult scanResult = source.readParcelable(
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        AdapterViewUtil.setOnItemClickListener(mScrollAdapterView, new AdapterViewUtil.OnItemClickListener() {
            @Override
