...
package com.rockon999.android.tv.settings.form;
...
import com.rockon999.android.tv.settings.firetv.util.TextViewUtil;
...
public abstract class MultiPagedForm extends DialogActivity implements ActionAdapter.Listener,
    ...
    private void attachListeners(EditTextFragment editTextFragment, final FormPage formPage) {
        ...
        editTextFragment.setOnEditorActionListener(new TextViewUtil.OnEditorActionListener() {
