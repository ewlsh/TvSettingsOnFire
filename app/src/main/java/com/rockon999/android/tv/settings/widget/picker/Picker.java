...
package com.rockon999.android.tv.settings.widget.picker;
...
public class Picker extends Fragment {
    ...
    private AdapterViewUtil.OnItemClickListener mOnClickListener = new AdapterViewUtil.OnItemClickListener() {
        @Override
    ...
    private void initAdapters() {
        ...
        for (int i = 0; i < totalCol; i++) {
            ...
            // REPLACED columnView.setOnItemClickListener(mOnClickListener);
            AdapterViewUtil.setOnItemClickListener(columnView, mOnClickListener);
